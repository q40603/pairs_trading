...
#           "31"]
    ...
    for m in range(len(month)):
        ...
        for i in range(len(day)):
            ...
            file = '20180103_averagePrice_min.csv'
            test = []
            h = 9
            m = 1
            ...
            day1.drop('date', axis=1, inplace=True)
            day1.drop('datetime', axis=1, inplace=True)
            ...
            for j in range(1):    # 一天建模??次
                ...
                path = r"C:/Users/MAI/Desktop/trading_result/after20200204/trading_period_matrix_ver1.0/table/20200602origin/"
