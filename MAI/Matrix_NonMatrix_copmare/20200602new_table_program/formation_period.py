...
#
#                    test = np.sum(np.log(lambda_model3[1]/lambda_model4[1])) * (len(min_price)-p)
#                    
#                    if test > 3.8414:
#                        continue
#                    
                    ...
                    test = np.sum(np.log((1-lambda_model3[0])/(1-lambda_model2[0])) * (len(min_price)-p))
                    #print(test)
                    if test < 0:
                        print('test32 error')
                        #raise ValueError('test23 error')
                    if test > 3.8414:
                        ...
                        test = np.sum(np.log((1-lambda_model1[1])/(1-lambda_model2[1])) * (len(min_price)-p))
                        if test < 0:
                            print('test12 error')
                            #raise ValueError('test23 error')
                        if test > 3.8414:
