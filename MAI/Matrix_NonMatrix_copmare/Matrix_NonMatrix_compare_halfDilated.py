# -*- coding: utf-8 -*-
"""
Created on Tue Mar  3 21:50:08 2020
...
test_volumePath = r'C:\Users\MAI\Desktop\half-min-API\accumulate_volume'
...
for year in years:
    for month in months:
        ...
        for day in days:
            ...
            test_vol_stock1 = test_vol_stock1[:,:-5]/test_v1_max
            test_vol_stock2 = test_vol_stock2[:,:-5]/test_v2_max
